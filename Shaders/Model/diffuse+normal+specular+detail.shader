...
//Uniforms
uniform sampler2D texture0;//Color and AO map
uniform sampler2D texture1;//normal map
uniform sampler2D texture2;//Detail specular map

uniform sampler2D texture3;//Detail diffuse map

uniform vec4 materialcolorspecular; //R value control the detail UV multiplication
...
void main(void)
{
	...
	//Specular R value control the detail UV
	vec4 color_specular = texture(texture2,ex_texcoords0*materialcolorspecular.r*20) ;
	...
	//Specular R value control the detail UV
	outcolor *= texture(texture3,ex_texcoords0*materialcolorspecular.r*20);
