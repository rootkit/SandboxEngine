...
void main()
{
	...
	ex_vertexposition=modelvertexposition;
...
@OpenGL4.Fragment
//Cube map code: credits to Shadmar
...
void main(void)
{
	...
	vec3 cubecoord = reflect(normalize(ex_vertexposition.xyz - cameraposition), normalize(cameranormalmatrix*ex_normal).xyz);
	outcolor=mix(outcolor, texture(texture4,cubecoord),.3);
